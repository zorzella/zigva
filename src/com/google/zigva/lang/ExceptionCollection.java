...
public final class ExceptionCollection extends RuntimeException {
  ...
  public final Collection<? extends RuntimeException> exceptions;
  
  public ExceptionCollection(Collection<? extends RuntimeException> exceptions) {
    super(String.format(
  ...
  public static RuntimeException create(Collection<? extends RuntimeException> exceptions) {
